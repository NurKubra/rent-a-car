...
public class ContactMessageService {
    ...
    public ResponseMessage<ContactMessageResponse> save(ContactMessageRequest contactMessageRequest) {
       ...
       if(isSameMessageWithSameEmailToday) {   // eger ayni gun icerisinde birden fazla mesaj varsa -TRUE
           ...
           //  DTO -> POJO
           ContactMessage contactMessage=createContactMessage(contactMessageRequest);       // DTO alip POJO'ya cevirdik.
              ContactMessage savedData  =contactMessageRepository.save(contactMessage);   // Cevirmis oldugumuz  POJO  classi Repository'e gonderdik-

          return ResponseMessage.<ContactMessageResponse>builder()
                .message("Contact Message Created Successfully")
                .httpStatus(HttpStatus.CREATED)
                .object(createResponse(savedData))          // POJO->DTO yapan methoda  POJO olan savedData objesini vererek DTO  cevirdik.
                .build();
